...
export const getServiceIcons = (isMobile) => {
    ...
    const AnimatedIcon = ({children, color}) => (
        <motion.div
    ...
    return {
        [POSITIONS.TOP_LEFT]: (
            <AnimatedIcon color={colors.globeColor}>
                <Globe size={iconSize} color={colors.globeColor} strokeWidth="1px"/>
            </AnimatedIcon>
        ),
        [POSITIONS.BOTTOM_LEFT]: (
            <AnimatedIcon color={colors.laptopColor}>
                <LaptopMinimalCheck
                    size={iconSize}
        ...
        [POSITIONS.TOP_RIGHT]: (
            <AnimatedIcon color={colors.brainColor}>
                <BrainCircuit
                    size={iconSize}
        ...
        [POSITIONS.BOTTOM_RIGHT]: (
            <AnimatedIcon color={colors.chartColor}>
                <ChartNoAxesCombined
                    size={iconSize}
